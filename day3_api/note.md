...
- Add this line to your `server.js` file: `app.use(express.urlencoded({ extended: true }));`
  **Extended option:** - `true`: allowing nested objects and arrays, example: `name=Loc&address={street: "123 Main St", city: "New York", state: "NY", zip: "10001"}` - `false`: not allowing nested objects and arrays, example: `name=Loc&address=123 Main St&city=New York&state=NY&zip=10001`
