...
registerRouter.route("/:subject")
  // .all(validation)
.post(function (req, res) {
  res.send("Bạn đã đăng ký ngành học: " + req.params.subject + ". Chào mừng bạn đến với ngôi trường của chúng tôi!");
})
.put(function (req, res) {
  res.send("Bạn đã cập nhật đăng ký ngành học: " + req.params.subject + ". Chào mừng bạn đến với ngôi trường của chúng tôi!");
})
.delete(function (req, res) {
  res.send("Bạn đã hủy đăng ký ngành học: " + req.params.subject + ". Chào mừng bạn đến với ngôi trường của chúng tôi!");
}); 
